package com.matejdro.pebblenotificationcenter.crashreport
...
import com.matejdro.pebblenotificationcenter.logging.FileLoggingControllerImpl
                  ...
                  ErrorReport(
                     ...
                     openGithubIssue = {
                        val searchIntent = Intent().apply {
                           ...
                           data = "https://github.com/matejdro/PebbleNotificationCenter2/issues/new".toUri()
                        }
...
private fun CrashReportPreview() {
   ...
   PreviewTheme {
      Column(verticalArrangement = Arrangement.spacedBy(16.dp), modifier = Modifier.padding(16.dp)) {
         ErrorReport(errorText, "Notification Center", {}, {}, {})
      }
   }
}
